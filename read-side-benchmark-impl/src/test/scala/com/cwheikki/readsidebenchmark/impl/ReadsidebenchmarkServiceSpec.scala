...
import com.cwheikki.readsidebenchmark.api._

class ReadsidebenchmarkServiceSpec extends AsyncWordSpec with Matchers with BeforeAndAfterAll {
  ...
  "read-side-benchmark service" should {
